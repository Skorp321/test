...
#RUN pip install ultralytics[export] albumentations pycocotools onnxruntime-gpu tensorrt wandb
# Install pip packages
RUN pip install uv
RUN uv pip install --system ultralytics[export] albumentations pycocotools onnxruntime-gpu tensorrt wandb
